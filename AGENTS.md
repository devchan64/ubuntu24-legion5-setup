...
> ubuntu24-legion5-setup 에이전트 협업 규약(SSOT)

이 문서는 VS Code와 Codex 계열 도구가 저장소 지침을 자동 인식할 수 있도록
루트의 `AGENTS.md`를 SSOT로 사용한다.
...
- 커밋 메시지 컨벤션은 **Conventional Commits**를 사용한다
  - 예: `feat: add continue inline autocomplete setup`
  - 예: `docs: add release notes index`
...
| 2026-04-19 | SSOT 문서명을 AGENTS.md로 변경하고 Conventional Commits 규칙 추가        |
